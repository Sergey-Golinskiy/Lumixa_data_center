...
<div class="page-actions" style="margin-bottom: 20px;">
    <a href="/admin/roles" class="btn btn-secondary">&laquo; <?= $this->__('back_to_list') ?></a>
</div>
    ...
    <div class="card-body">
        <form method="post" action="<?= $role ? '/admin/roles/' . $role['id'] . '/edit' : '/admin/roles/create' ?>">
            ...
            <div class="form-group">
                <label for="name"><?= $this->__('role_name') ?> <span class="required">*</span></label>
            ...
            <div class="form-group">
                <label><?= $this->__('permissions') ?></label>
            ...
            <div class="form-actions" style="margin-top: 20px;">
                <button type="submit" class="btn btn-primary"><?= $role ? $this->__('update') : $this->__('create') ?></button>
                <a href="/admin/roles" class="btn btn-secondary"><?= $this->__('cancel') ?></a>
            </div>
        </form>
    </div>
</div>
