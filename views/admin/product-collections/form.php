...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0"><?= $collection ? $this->__('edit_collection') : $this->__('create_collection') ?></h5>
            </div>
            <div class="card-body">
                <form method="POST" action="<?= $collection ? "/admin/product-collections/{$collection['id']}" : '/admin/product-collections' ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="description" name="description" class="form-control" rows="4"><?= $this->e($collection['description'] ?? $this->old('description')) ?></textarea>
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="/admin/product-collections" class="btn btn-soft-secondary">
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <a href="/admin/product-collections" class="btn btn-soft-primary w-100">
                    <i class="ri-arrow-left-line me-1"></i>
