                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center pt-4">
                            <div class="">
                                <h1 class="display-1 fw-medium text-white">4<span class="text-danger mx-2">0</span>3</h1>
                            </div>
                            <div class="mt-n4">
                                <h3 class="text-uppercase text-white">Access Denied</h3>
                                <p class="text-white-75 mb-4"><?= htmlspecialchars($message ?? "You don't have permission to access this page.") ?></p>
                                <a href="/" class="btn btn-success"><i class="ri-home-line me-1"></i>Back to home</a>
                                <a href="javascript:history.back()" class="btn btn-light ms-2"><i class="ri-arrow-left-line me-1"></i>Go Back</a>
                            </div>
                        </div>
                    </div>
                </div>
