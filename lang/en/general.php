...
return [
    ...
    'printers_online' => ':count Printer(s) Online',
    'warehouse_receipt_desc' => 'Record incoming goods',
    'print_job_desc' => 'Add job to print queue',
    'production_order_desc' => 'Create production order',
    'product_desc' => 'Add new product to catalog',
    'item_desc' => 'Add new warehouse item',
    'detail_desc' => 'Add new printed detail',
    'details' => 'Details',
    ...
    'product_code_placeholder' => 'e.g., PROD-001',
    ...
    'company_or_individual_name' => 'Company or individual name',
    ...
    // Product Collections
    'nav_product_collections' => 'Product Collections',
    'product_collections' => 'Product Collections',
    'collection' => 'Collection',
    'no_collection' => 'No collection',
    'create_collection' => 'Create Collection',
    'edit_collection' => 'Edit Collection',
    'edit_collection_title' => 'Edit Collection: :name',
    ...
    'missing_data_for_calculation' => 'Missing data for full calculation',
    'missing_material_qty' => 'Material quantity not specified',
    'missing_print_time' => 'Print time not specified',
    'missing_material_price' => 'Material has no price (no receipts in stock)',
    'missing_material_not_selected' => 'Material not selected',
    'missing_printer_not_found' => 'Printer not found',
    'missing_printer_not_selected' => 'Printer not selected',
    'missing_not_printed_detail' => 'Not a printed detail',
    ...
    'material_cost_per_gram' => 'Material cost per gram',
    ...
    'detail_printed' => 'Detail (Printed)',
    'purchased_component' => 'Purchased Component',
    'no_components' => 'No components in composition',
    'confirm_remove_component' => 'Remove this component from composition?',
    'add_detail' => 'Add Detail',
    'add_component' => 'Add Component',
    'add_detail_to_composition' => 'Add Detail to Composition',
    'add_item_to_composition' => 'Add Component to Composition',
    'assembly_cost' => 'Assembly Cost',
    'assembly_cost_hint' => 'Additional labor cost for product assembly',
    'update_assembly_cost' => 'Update Assembly Cost',
    ...
    'items' => 'items',
    'select_detail_placeholder' => 'Search details by SKU or name...',
    'select_item_placeholder' => 'Search items by SKU or name...',
    'cost_override' => 'Override Cost',
    'cost_override_hint' => 'Manually set unit cost instead of calculated',
    'recalculate_costs' => 'Recalculate Costs',
    'costs_recalculated' => 'Product costs recalculated successfully',
    ...
    'payment_status_partial' => 'Partial Payment',
    ...
    'view_in_source' => 'View in Source',
    'external_id' => 'External ID',
    'local_product' => 'Local Product',
    'customer_notes' => 'Customer Notes',
    'internal_notes' => 'Internal Notes',
    'internal_notes_help' => 'Not visible to customer',
    'sales_orders_table_missing' => 'Sales orders table is missing. Please run migrations.',
    'currency' => 'Currency',
    ...
    'store_url' => 'Store URL',
    'store_url_help' => 'Your WooCommerce store address (e.g. https://shop.example.com)',
    'store_url_required' => 'Store URL is required',
    'consumer_key' => 'Consumer Key',
    'consumer_key_required' => 'Consumer Key is required',
    'consumer_secret' => 'Consumer Secret',
    'consumer_secret_required' => 'Consumer Secret is required',
    ...
    'auto_sync_help' => 'Automatically check for new orders at the specified interval',
    'sync_interval_minutes' => 'Sync interval (minutes)',
    'sync_interval_help' => 'Minimum 5 minutes',
    'sync_order_statuses' => 'Sync orders with statuses',
    'manual_sync' => 'Manual Sync',
    'sync_now' => 'Sync Now',
    'manual_sync_help' => 'Fetch new orders from WooCommerce immediately',
    'save_settings' => 'Save Settings',
    'settings_saved_success' => 'Settings saved successfully',
    'woocommerce_settings_incomplete' => 'Please fill in all WooCommerce settings',
    'woocommerce_connection_success' => 'WooCommerce connection successful',
    'woocommerce_connection_failed' => 'Failed to connect to WooCommerce',
    'woocommerce_sync_success' => 'Synced successfully: :created new, :updated updated',
    'woocommerce_sync_failed' => 'Sync failed',
    ...
    'duration' => 'Duration',
    'automatic' => 'Automatic',
    'sync_status_started' => 'Started',
    'sync_status_completed' => 'Completed',
    'sync_status_failed' => 'Failed',

    // WooCommerce Status Sync
    'woocommerce_order_statuses' => 'WooCommerce Order Statuses',
    'sync_statuses' => 'Sync Statuses',
    'no_statuses_synced' => 'No statuses synced yet',
    'test_connection_to_sync_statuses' => 'Click "Test Connection" to sync statuses from WooCommerce',
    'status_mapping_help' => 'Configure mapping between WooCommerce statuses and internal system statuses. Enable sync for statuses whose orders should be imported.',
    ...
    'syncing' => 'Syncing',
    'saving' => 'Saving',
    'status_mapping_updated' => 'Status mapping updated',
    'statuses_synced_success' => 'Synced :synced statuses, added :added new',
    ...
    'orders_settings' => 'Orders',
    'orders_settings_desc' => 'Order statuses and settings',
    'nav_order_statuses' => 'Order Statuses',
    'order_statuses' => 'Order Statuses',
    'order_status' => 'Order Status',
    'create_order_status' => 'Create Status',
    'edit_order_status' => 'Edit Status',
    'edit_order_status_title' => 'Edit: :name',
    'order_status_code_required' => 'Status code is required',
    'order_status_code_too_long' => 'Code must not exceed 50 characters',
    'order_status_code_exists' => 'Status code already exists',
    'order_status_code_hint' => 'Only letters, numbers and underscore (e.g., pending, in_progress)',
    'order_status_name_required' => 'Status name is required',
    'order_status_name_too_long' => 'Name must not exceed 100 characters',
    'order_status_color_invalid' => 'Invalid color format (use HEX, e.g. #3b82f6)',
    'order_status_created_success' => 'Status created successfully',
    'order_status_updated_success' => 'Status updated successfully',
    'order_status_deleted_success' => 'Status deleted successfully',
    'order_status_in_use' => 'Cannot delete status: it is used by :count order(s)',
    'order_statuses_table_missing' => 'Order statuses table is missing. Run migrations to create it.',
    'confirm_delete_order_status' => 'Delete this status?',
    'cannot_delete_default_status' => 'Cannot delete the default status',
    'default_status' => 'Default status',
    'final_status' => 'Final status',
    'order_status_active_hint' => 'Status can be used for orders',
    'order_status_default_hint' => 'Automatically assigned to new orders',
    'order_status_final_hint' => 'Order is considered closed (completed, cancelled, etc.)',
    'order_status_description_placeholder' => 'Description of when this status is used...',
